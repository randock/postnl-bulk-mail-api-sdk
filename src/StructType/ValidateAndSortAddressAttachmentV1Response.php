...
class ValidateAndSortAddressAttachmentV1Response extends AbstractStructBase
{
     ...
     */
    public $ValidateAndSortAddressAttachmentV1Result;
    /**
     ...
     */
    public function getValidateAndSortAddressAttachmentV1Result()
    {
     ...
     */
    public function setValidateAndSortAddressAttachmentV1Result(\Randock\PostNL\BulkMailApi\StructType\B2BAddressContainerV1 $validateAndSortAddressAttachmentV1Result = null)
    {
