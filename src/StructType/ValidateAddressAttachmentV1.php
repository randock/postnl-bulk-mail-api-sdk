...
/**
 * This class stands for ValidateAddressAttachmentV1 StructType
 * @subpackage Structs
 */
class ValidateAddressAttachmentV1 extends AbstractStructBase
{
    /**
     * The request
    ...
    /**
     * Constructor method for ValidateAddressAttachmentV1
     * @uses ValidateAddressAttachmentV1::setRequest()
     ...
     * @param \Randock\PostNL\BulkMailApi\StructType\B2BAddressContainerV1 $request
     * @return \Randock\PostNL\BulkMailApi\StructType\ValidateAddressAttachmentV1
     */
