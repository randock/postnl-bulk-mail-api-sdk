...
/**
 * This class stands for ValidateAndSortAddressAttachmentV1 StructType
 * @subpackage Structs
 */
class ValidateAndSortAddressAttachmentV1 extends AbstractStructBase
{
    /**
     * The request
    ...
    /**
     * Constructor method for ValidateAndSortAddressAttachmentV1
     * @uses ValidateAndSortAddressAttachmentV1::setRequest()
     ...
     * @param \Randock\PostNL\BulkMailApi\StructType\B2BAddressContainerV1 $request
     * @return \Randock\PostNL\BulkMailApi\StructType\ValidateAndSortAddressAttachmentV1
     */
