...
/**
 * This class stands for CountrySubDivisionCodeType StructType
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: tns:CountrySubDivisionCodeType
 * @subpackage Structs
 */
class CountrySubDivisionCodeType extends AbstractStructBase
{
    /**
     * The Value
     * Meta information extracted from the WSDL
    ...
    public $name;
    /**
     * Constructor method for CountrySubDivisionCodeType
     * @uses CountrySubDivisionCodeType::setValue()
     * @uses CountrySubDivisionCodeType::setLanguageID()
     * @uses CountrySubDivisionCodeType::setListAgencyID()
     * @uses CountrySubDivisionCodeType::setListAgencyName()
     * @uses CountrySubDivisionCodeType::setListID()
     * @uses CountrySubDivisionCodeType::setListName()
     * @uses CountrySubDivisionCodeType::setListSchemeURI()
     * @uses CountrySubDivisionCodeType::setListURI()
     * @uses CountrySubDivisionCodeType::setListVersionID()
     * @uses CountrySubDivisionCodeType::setName()
     * @param string $value
