 ...
 * - nillable: true
 * - type: tns:BusinessScopeInstanceID
 * @subpackage Structs
 */
class BusinessScopeInstanceID extends AbstractStructBase
{
    /**
     * The Value
     * Meta information extracted from the WSDL
     ...
     * @uses BusinessScopeInstanceID::setSchemeAgencyID()
     * @uses BusinessScopeInstanceID::setSchemeID()
     * @param string $value
