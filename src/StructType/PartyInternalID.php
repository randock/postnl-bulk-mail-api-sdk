...
/**
 * This class stands for PartyInternalID StructType
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: tns:PartyInternalID
 * @subpackage Structs
 */
class PartyInternalID extends AbstractStructBase
{
    /**
     * The Value
     * Meta information extracted from the WSDL
    ...
    public $schemeID;
    /**
     * Constructor method for PartyInternalID
     * @uses PartyInternalID::setValue()
     * @uses PartyInternalID::setSchemeAgencyID()
     * @uses PartyInternalID::setSchemeID()
     * @param string $value
     ...
     * @param string $value
     * @return \Randock\PostNL\BulkMailApi\StructType\PartyInternalID
     */
