...
/**
 * This class stands for CodeType StructType
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: tns:CodeType
 * @subpackage Structs
 */
class CodeType extends AbstractStructBase
{
    /**
     * The Value
     * Meta information extracted from the WSDL
     ...
     * @uses CodeType::setValue()
     * @uses CodeType::setListAgencyID()
     * @uses CodeType::setListAgencySchemeAgencyID()
     * @uses CodeType::setListAgencySchemeID()
     * @uses CodeType::setListID()
     * @uses CodeType::setListVersionID()
     * @param string $value
     ...
     * @param string $value
     * @return \Randock\PostNL\BulkMailApi\StructType\CodeType
     */
