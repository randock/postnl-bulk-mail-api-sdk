...
class ArrayOfContactPersonType extends AbstractStructArrayBase
{
     ...
     */
    protected ?array $ContactPersonType = null;
    /**
     ...
     */
    public function __construct(?array $contactPersonType = null)
    {
        $this
     ...
     */
    public function getContactPersonType(): ?array
    {
     ...
     */
    public static function validateContactPersonTypeForArrayConstraintsFromSetContactPersonType(?array $values = []): string
    {
        if (!is_array($values)) {
            return '';
        }
     ...
     */
    public function setContactPersonType(?array $contactPersonType = null): self
    {
     ...
     */
    public function current(): ?\Randock\PostNL\BulkMailApi\StructType\ContactPersonType
    {
     ...
     * @return \Randock\PostNL\BulkMailApi\StructType\ContactPersonType|null
     */
    public function item($index): ?\Randock\PostNL\BulkMailApi\StructType\ContactPersonType
    {
     ...
     * @return \Randock\PostNL\BulkMailApi\StructType\ContactPersonType|null
     */
    public function first(): ?\Randock\PostNL\BulkMailApi\StructType\ContactPersonType
    {
        return parent::first();
    }
    /**
     ...
     * @return \Randock\PostNL\BulkMailApi\StructType\ContactPersonType|null
     */
    public function last(): ?\Randock\PostNL\BulkMailApi\StructType\ContactPersonType
    {
        return parent::last();
    }
    /**
     ...
     * @return \Randock\PostNL\BulkMailApi\StructType\ContactPersonType|null
     */
    public function offsetGet($offset): ?\Randock\PostNL\BulkMailApi\StructType\ContactPersonType
    {
