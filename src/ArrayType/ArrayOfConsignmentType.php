 ...
 * - nillable: true
 * - type: tns:ArrayOfConsignmentType
 * @subpackage Arrays
 */
class ArrayOfConsignmentType extends AbstractStructArrayBase
{
    /**
     * The ConsignmentType
     * Meta information extracted from the WSDL
    ...
    /**
     * This method is responsible for validating the values passed to the setConsignmentType method
     * This method is willingly generated in order to preserve the one-line inline validation within the setConsignmentType method
     * @param array $values
    ...
    public static function validateConsignmentTypeForArrayConstraintsFromSetConsignmentType(?array $values = []): string
    {
        ...
        foreach ($values as $arrayOfConsignmentTypeConsignmentTypeItem) {
            ...
            if (!$arrayOfConsignmentTypeConsignmentTypeItem instanceof \Randock\PostNL\BulkMailApi\StructType\ConsignmentType) {
                $invalidValues[] = is_object($arrayOfConsignmentTypeConsignmentTypeItem) ? get_class($arrayOfConsignmentTypeConsignmentTypeItem) : sprintf('%s(%s)', gettype($arrayOfConsignmentTypeConsignmentTypeItem), var_export($arrayOfConsignmentTypeConsignmentTypeItem, true));
            }
        }
